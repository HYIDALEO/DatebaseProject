...
<html>
  <head>
    ...
    <title>My JSP 'buyTicketList.jsp' starting page</title>
  ...
  <body>
    ...
    <table class="table table-hover">  
        ...
        <tr>  
            ...
            <td colspan="3">  
                <a href="backBookServlet?ID=<%=s.getID()%>&UID=<%=session.getAttribute("UID")%>&ticketNum=<%=s.getTicketNum()%>" onclick="return confirm('book?')">tuiding</a>  
            </td>  
        </tr>  
        <%   
            }  
