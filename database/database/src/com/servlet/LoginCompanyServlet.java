 ...
 */
@WebServlet("/LoginCompanyServlet")
public class LoginCompanyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            String sql = "select distinct * from companyList where NAME = '"+un+"' and PW = '"+pw+"'";    
            ...
            if(result.next()){  
                request.getRequestDispatcher("welcomeCompany.jsp").forward(request, response);  
            }else{  
