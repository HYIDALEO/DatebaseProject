  ...
  <body  style="background-image:url('images/timg.jpg');background-size: cover;  ">
    ...
    <form action="loginManagerServlet" method="post">  
    	<div class="form-group">
    		...
    		<input type="text" name="username" class="form-control" id="InputManager" placeholder="managerName">
    	</div>
    	<div class="form-group">
    		<label for="InputManagerPW">password</label>
    		<input type="password" name="password" class="form-control" id="InputManagerPW">
