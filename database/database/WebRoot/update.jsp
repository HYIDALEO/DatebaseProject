  	...
  	<div style="margin-left:350px;width:700px;opacity:0.9;height:100%;">
    	...
    	<form action="updateServlet" method="post"> 
			    ...
			    <div class="form-group">
			    	...
			    	<input type="text" name="airplanePriceš" class="form-control" id="airplanePriceš" value="<%=airplanePrice %>">
			    </div> 	    
			    <div class="form-group">
			    	<label for="ticketNumš">ticketNumš</label>
			    	<input type="text" name="ticketNumšš" class="form-control" id="ticketNumšš" value="<%=ticketNum %>">
			    </div>     
