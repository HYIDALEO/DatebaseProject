  ...
  <body  style="background-image:url('images/timg.jpg');background-size: cover;  ">
    ...
    <form action="loginCompanyServlet" method="post">  
    	<div class="form-group">
    		...
    		<input type="text" name="username" class="form-control" id="InputCompany" placeholder="companyName">
    	</div>
    	<div class="form-group">
    		<label for="InputCompanyPW">password</label>
    		<input type="password" name="password" class="form-control" id="InputCompanyPW">
